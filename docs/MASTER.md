...
| Versión | 2.0 (May 12, 2026) — cierre Subfase 5.2 Chrome global, D38-1 a D38-3, src/components/layout/ canónica, DT-01 corregido a 5/7, DT-09 cerrado retroactivo |
...
|---|---|---|---|---|
| DT-01 | `"34667326300"` hardcoded en 7 archivos (ContactForm, CTASection, Footer, FormSection, Header, PricingSection, Portfolio) + bug `34634408043` en WhyUs. Extraer a `VITE_WHATSAPP_NUMBER` | INVENTORY §16.2, AGENT.md §⚙️ | Fase 5.1-5.4 (REBUILD natural de cada componente: Header, Footer, Hero, FormSection, WhatsAppButton; CTASection, PricingSection, WhyUs DESCARTAR) | 5/7 cerrados en Subfase 5.2 (corregido: Portfolio.tsx limpio por grep, no tenía hardcode). Pendientes: ContactForm.tsx, FormSection.tsx → Subfase 5.4 |
