...
**Estructura:** full-bleed antes/después con slider (`react-compare-image`). H2 aligned right Playfair, caption editorial, CTA a /portfolio.
...
**Nota técnica:** este bloque reutiliza `react-compare-image` ya instalado (DT-12 se cierra aquí y en /portfolio Bloque C).
...
**Estructura:** grid 2 cols desktop, 1 col mobile, aspect 4:3 horizontal. Slider `react-compare-image` horizontal. Badge dinámico "Original / Editada" según posición del slider. Caption editorial por imagen.
